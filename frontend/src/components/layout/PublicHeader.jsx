...
function PublicHeader() {
  return (
    <header className="w-full h-14 flex items-center px-margin-mobile md:px-margin-desktop bg-background/80 backdrop-blur-md sticky top-0 z-50">
      <div className="max-w-[1280px] mx-auto w-full flex justify-between items-center">
        <Link to="/" className="font-display-lg text-[18px] text-primary font-bold">
          ShaadiHub
        </Link>
