function AuthLayout({ imageUrl, imageAlt, headline, bodyText, children }) {
  return (
    <main className="flex-grow flex items-center justify-center py-8 px-margin-mobile md:px-margin-desktop relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl grid grid-cols-1 lg:grid-cols-2 bg-surface-container-lowest rounded-xl shadow-lg border border-outline-variant overflow-hidden">
        <div className="hidden lg:block relative min-h-[520px]">
          ...
          <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
            <h2 className="font-display-lg text-display-lg-mobile mb-3">{headline}</h2>
            <p className="font-body-md text-body-sm opacity-90 max-w-md">{bodyText}</p>
          </div>
        </div>
